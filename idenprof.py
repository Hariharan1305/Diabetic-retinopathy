...
def train_network():
    ...
    model.fit_generator(train_generator, steps_per_epoch=int(249 / batch_size), epochs=epochs,
                        validation_data=test_generator,
                        validation_steps=int(249 / batch_size), callbacks=[checkpoint, lr_scheduler])


# ----------------- The Section Responsible for Inference ---------------------
CLASS_INDEX = None

MODEL_PATH = os.path.join(execution_path, "idenprof_weight_model.095-1.0.h5")
...
def run_inference():
    ...
    picture = os.path.join(execution_path, "check.jpeg")
    ...
    print(str(predictiondata[0][0]), " : ", str(predictiondata[0][1] * 100))
